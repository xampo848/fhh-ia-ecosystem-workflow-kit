# Repo Overlay All Metrics Full

This pack provides a complete repository overlay mirrored from the `.agents2` source in the All Metrics project.

Use this pack when you want to install the full All Metrics workflow surface instead of the minimal starter placeholders.
