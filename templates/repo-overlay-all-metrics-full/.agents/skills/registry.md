...
This file is the neutral registry for AI-executable skills in All Metrics.
...
| `playwright-testing` | Quality/validation | `.agents/skills/03-quality/playwright-testing/SKILL.md` | User asks for Playwright tests or E2E validation is required | Just-in-time | balanced | `playwright-testing` | Requires Playwright tooling if used. |
| `react-doctor` | Quality/validation | `.agents/skills/03-quality/react-doctor/SKILL.md` | Meaningful React changes need post-change audit | Just-in-time | balanced | `react-doctor` | External command/tool availability follows runtime/tool policy. |
