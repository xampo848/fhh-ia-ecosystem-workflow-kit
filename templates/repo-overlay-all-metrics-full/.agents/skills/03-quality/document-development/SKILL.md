...
description: "Genera documentación profesional de un desarrollo en All Metrics — técnica y no técnica. Produce un documento Markdown estructurado en docs/internal-documentation/ con secciones de contexto, flujo de usuario, reglas de negocio, casos de uso, arquitectura técnica con diagrama Mermaid, límites operativos, robustez, guía de uso, impacto, FAQ, glosario y anexo técnico. Usar cuando: documentar una feature terminada, crear guía para stakeholders no técnicos, explicar un sistema existente, documentar decisiones de diseño, entregar documentación junto a un PR."
