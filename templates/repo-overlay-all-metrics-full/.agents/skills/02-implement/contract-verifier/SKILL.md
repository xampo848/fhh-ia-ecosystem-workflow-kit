...
description: "Delegate-only skill for implement-prd. Alias: Guardia Contrato. Verifies backend and frontend API contracts in All Metrics, including serializers, controller responses, hooks, query payloads, tests, empty states, and data-shape mismatches. Use whenever backend responses feed frontend behavior."
---
