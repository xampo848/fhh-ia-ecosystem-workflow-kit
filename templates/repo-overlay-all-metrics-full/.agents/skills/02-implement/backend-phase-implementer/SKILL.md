...
description: "Delegate-only skill for implement-prd. Alias: Turbo Backend. Implements backend slices in All Metrics Rails API, including models, migrations, services, controllers, serializers, background jobs, i18n, and Minitest. Use only with explicit file ownership from the orchestrator."
---
