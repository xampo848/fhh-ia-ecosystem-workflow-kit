...
description: "Delegate-only skill for implement-prd. Alias: QA Relampago. Performs final fresh-context QA for an All Metrics PRD implementation, reviewing diffs, acceptance coverage, tenancy, auth, i18n, contracts, UI states, validations, and delivery risks. Use before final response or PR handoff."
context: fork
---
