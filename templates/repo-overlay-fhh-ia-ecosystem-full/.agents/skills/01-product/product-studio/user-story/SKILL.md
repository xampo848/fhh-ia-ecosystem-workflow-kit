...
- When stories are too large, split first with the User Story Splitting companion skill if available
...
- **User persona:** Who is this for? (reference the Proto-Persona companion skill if available)
- **Problem understanding:** What need does this address? (reference the Problem Statement companion skill if available)
...
**Red flags:**
- **Multiple Whens/Thens:** Sign of scope creep, split the story with the User Story Splitting companion skill if available
...
- **Check for splitting:** If the story feels too big, use the User Story Splitting companion skill if available
...
See [examples/sample.md](examples/sample.md) for full examples (good, bad, and split-needed stories).
...
**Fix:** Use specific personas: "As a trial user," "As a paid subscriber," "As an admin," etc. (reference the Proto-Persona companion skill if available)
...
**Fix:** Split the story using the User Story Splitting companion skill if available. Each When/Then pair should be its own story, or at least be evaluated for splitting.
...
### Related Skills
- User Story Splitting companion skill — breaks large stories into smaller ones
- Proto-Persona companion skill — defines the "As a [persona]" section
- Problem Statement companion skill — stories should address validated problems
- Epic Hypothesis companion skill — epics decompose into user stories

### Optional Helpers
- [scripts/user-story-template.py](scripts/user-story-template.py) — deterministic Markdown stub generator, no network access
...
**Dependencies:** References the Proto-Persona and Problem Statement companion skills when available
**Used by:** User Story Splitting and Epic Hypothesis companion skills
