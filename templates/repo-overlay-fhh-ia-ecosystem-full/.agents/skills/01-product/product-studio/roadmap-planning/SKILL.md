...
- **Use:** Insights from [../discovery-process/SKILL.md](../discovery-process/SKILL.md) (if recently completed)
- **Questions:**
...
See [examples/sample.md](examples/sample.md) for full roadmap examples.
...
- [../prioritization-advisor/SKILL.md](../prioritization-advisor/SKILL.md) — choose the scoring framework
- [../product-strategy-session/SKILL.md](../product-strategy-session/SKILL.md) — establish strategy before sequencing
- [../discovery-process/SKILL.md](../discovery-process/SKILL.md) — provide validated customer problem inputs
...
**Dependencies:** Orchestrates the Epic Hypothesis companion skill, [../prioritization-advisor/SKILL.md](../prioritization-advisor/SKILL.md), plus manual activities
