...
- **Methodology:** Use the Discovery Interview Prep companion skill for problem validation, JTBD, and switch interviews
...
**3. Write PRD (If GO)**
- **Use:** [../../create-prd/SKILL.md](../../create-prd/SKILL.md) (workflow)
- **Participants:** PM
- **Duration:** 1-2 days
...
│  └─ [Optional] Proto-Persona companion skill, Jobs-to-be-Done skill
│
├─ Day 3: Research Planning
│  ├─ Discovery Interview Prep companion skill (90 min)
...
└─ Decide & Document
  ...
  ├─ [If GO] Epic Hypothesis companion skill (60 min per epic)
  ├─ [If GO] Create PRD skill (1-2 days)
...
See [examples/sample.md](examples/sample.md) for a full discovery process example.
...
**Fix:** Use Mom Test questions from the Discovery Interview Prep companion skill (focus on past behavior)
...
- [../jobs-to-be-done/SKILL.md](../jobs-to-be-done/SKILL.md) — optional JTBD input during framing

Elsewhere in this repo:
- [../../create-prd/SKILL.md](../../create-prd/SKILL.md) — PRD workflow after a go decision
