...
Use [template.md](template.md) for the full fill-in structure.
...
- **Use:** Positioning Workshop companion skill (interactive, not bundled in product-studio)
- **Participants:** PM, product leadership, marketing, sales
- **Duration:** 90 minutes
- **Output:** Draft positioning statement

**2. Define Proto-Personas**
- **Use:** Proto-Persona companion skill (component, not bundled in product-studio)
- **Participants:** PM, design, customer-facing teams
- **Duration:** 60 minutes
- **Output:** 1-3 proto-personas (hypothesis-driven)

**3. Map Jobs-to-be-Done**
- **Use:** [../jobs-to-be-done/SKILL.md](../jobs-to-be-done/SKILL.md) (component)
...
- **Use:** Discovery Interview Prep companion skill (interactive, not bundled in product-studio)
...
- **Use:** Problem Framing Canvas companion skill (interactive, not bundled in product-studio)
...
- **Use:** Problem Statement companion skill (component, not bundled in product-studio)
- **Participants:** PM
- **Duration:** 30 minutes
- **Output:** Structured problem statement for PRD/roadmap

**3. Map Customer Journey (Optional)**
- **Use:** Customer Journey Mapping Workshop companion skill (interactive, not bundled in product-studio)
...
- **Use:** Opportunity Solution Tree companion skill (interactive, not bundled in product-studio)
...
- **Use:** Lean UX Canvas companion skill (interactive, not bundled in product-studio)
...
- **Use:** Epic Hypothesis companion skill (component, not bundled in product-studio)
- **Participants:** PM
- **Duration:** 60 minutes per epic
- **Output:** Epic hypothesis statements for top 3-5 initiatives

**3. Create User Story Map (Optional)**
- **Use:** User Story Mapping Workshop companion skill (interactive, not bundled in product-studio)
...
- Design POC experiments from the Opportunity Solution Tree companion skill output
...
- **Use:** [../prioritization-advisor/SKILL.md](../prioritization-advisor/SKILL.md) (interactive)
- **Participants:** PM
- **Duration:** 30 minutes
...
- **Use:** TAM/SAM/SOM Calculator companion skill (interactive, not bundled in product-studio)
...
- **Use:** Press Release companion skill (component, not bundled in product-studio)
...
- **Use:** Epic Breakdown Advisor companion skill (interactive, not bundled in product-studio)
- **Participants:** PM, design, engineering
- **Duration:** 90 minutes
- **Output:** User stories split by patterns (workflow, CRUD, business rules, etc.)

**2. Write User Stories**
- **Use:** [../user-story/SKILL.md](../user-story/SKILL.md) (component)
- **Participants:** PM
...
│  ├─ Positioning Workshop companion skill (90 min)
│  ├─ Proto-Persona companion skill (60 min)
│  └─ Jobs-to-be-Done skill (60 min)
│
├─ Day 3-5: Problem Framing & Validation
│  ├─ Problem Framing Canvas companion skill (120 min)
│  ├─ Problem Statement companion skill (30 min)
│  └─ [Optional] Customer Journey Mapping Workshop companion skill (90 min)
│
└─ Decision: Validate problem? (if NO, +1 week discovery)

Week 2:
├─ Day 1-3: Solution Exploration
│  ├─ Opportunity Solution Tree companion skill (90 min)
│  ├─ Epic Hypothesis companion skill (60 min per epic)
│  └─ [Optional] User Story Mapping Workshop companion skill (120 min)
│
├─ Decision: Test solutions? (if YES, +1-2 weeks experiments)
│
└─ Day 4-5: Prioritization & Roadmap
   ├─ Prioritization Advisor skill (30 min)
...
└─ Stakeholder Alignment
   ├─ [Optional] Press Release companion skill (60 min)
   ├─ Present strategy (60 min)
   └─ Refine based on feedback (1-2 days)

Week 4:
└─ Execution Planning
   ├─ Epic Breakdown Advisor companion skill (90 min)
   ├─ User Story skill (30 min per story)
...
See [examples/sample.md](examples/sample.md) for a full strategy session example.
...
Bundled in product-studio:
- [../jobs-to-be-done/SKILL.md](../jobs-to-be-done/SKILL.md) — customer jobs, pains, and gains input
- [../prioritization-advisor/SKILL.md](../prioritization-advisor/SKILL.md) — prioritization framework selection
- [../user-story/SKILL.md](../user-story/SKILL.md) — development-ready story output

Companion skills, not bundled in product-studio:
