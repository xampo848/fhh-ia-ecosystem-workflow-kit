...
- **Target customer segment:** Who are you studying? (reference the Proto-Persona companion skill if available in your workspace)
...
- **Cross-reference with personas:** Do different personas have different jobs/pains/gains? (reference the Proto-Persona companion skill if available in your workspace)
...
See [examples/sample.md](examples/sample.md) for full JTBD examples.
...
### Related Skills
- Proto-Persona companion skill — defines who has these jobs, pains, and gains
- Problem Statement companion skill — JTBD informs the "Trying to" and "But" sections
- Positioning Statement companion skill — JTBD informs the "that need" statement
...
**Dependencies:** References the Proto-Persona companion skill when available
**Used by:** Positioning Statement, Problem Statement, and Epic Hypothesis companion skills
