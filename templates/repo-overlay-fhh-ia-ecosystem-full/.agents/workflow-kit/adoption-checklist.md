...
Use this checklist before reusing the FHH IA Ecosystem workflow kit in another repo.
...
- [ ] Replace FHH IA Ecosystem-specific pattern skills with local pattern skills.
